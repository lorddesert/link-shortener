...
import { SHORTEN_LINK_INITIAL_STATE } from "./lib/utils";
...
function NewLinkCard(shortLink: { originalURL: string; newURL: string; alreadyExists: undefined; }): React.ReactNode {
  ...
  function Loader() {
    return (
      <div className="flex justify-center items-center my-10">
        <p className="mr-4 text-2xl">Loading</p>
        <div role="status" className="block">
